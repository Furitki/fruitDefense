...
- **Stroke language:** every icon uses the same warm-brown medium outline family. Internal cream strokes remain materially thicker than the outline at 96px, including pause, check, close, and exclamation glyphs.
