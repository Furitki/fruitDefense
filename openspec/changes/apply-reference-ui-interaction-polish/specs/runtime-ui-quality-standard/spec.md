...
- **THEN** validation proves its token ownership, bounded duration, scale-at-or-below-one containment, cancellation behavior, exact resting geometry, semantic non-motion cues, and absence of input drift
