...
- [x] 1.2 Publish `oper` to `origin` with upstream tracking while preserving the existing dirty development checkout.
...
- [x] 3.3 Commit the release-branch policy and OpenSpec artifacts, fast-forward `oper`, and verify both worktrees' Git state.
