...
## 5. Focused Drag Feedback

- [x] 5.1 Show the floating drag hint only for legal merges and size its frame to compact bounded content width
- [x] 5.2 Add smoke coverage proving non-merge targets suppress the floating hint while legal merges retain it
