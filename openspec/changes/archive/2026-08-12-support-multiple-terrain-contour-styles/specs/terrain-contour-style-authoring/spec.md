...
The accepted square grass/soil sample SHALL use authored or image-generated source information at a native target of at least 128 pixels per visual tile, SHALL package a scale-aware top-down transition independent of source-side-view lighting, and MUST NOT reintroduce the legacy narrow dark contact ribbon.
