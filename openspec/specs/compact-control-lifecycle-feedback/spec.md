# compact-control-lifecycle-feedback Specification

## Purpose

Define the current semantic action-color, tintable-glyph, compact-control surface, state-pairing, and acceptance contracts for the runtime UI.
