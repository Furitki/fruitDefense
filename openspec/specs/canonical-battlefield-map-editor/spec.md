# canonical-battlefield-map-editor Specification

## Purpose
Define the bounded canonical battlefield map editor, its authoring model, validation, publication, playtest, and end-to-end acceptance contract.
